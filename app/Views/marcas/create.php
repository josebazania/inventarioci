...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        ...
        <form action="<?= base_url('marcas/store') ?>" method="POST" class="p-6 space-y-5">
            <?= csrf_field() ?>
            ...
            <div class="flex gap-3 pt-4"><button type="submit" class="bg-primary-600 hover:bg-primary-700 text-white px-6 py-2.5 rounded-lg transition">Guardar</button><a href="<?= base_url('marcas') ?>" class="text-gray-600 hover:text-gray-800 px-4 py-2.5">Cancelar</a></div>
        </form>
    </div>
</div>
<?= $this->endSection() ?>
